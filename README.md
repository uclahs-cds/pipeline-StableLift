...
<img src="./docs/stablelift-overview.svg" width="80%">
...
| ------------------------ | -------------------- | ------------------------------------------------------------ | ------------------------------------------------------------------- |
| `docker_image_bcftools`  | `bcftools_version`   | `ghcr.io/uclahs-cds/bcftools-score:1.20_score-1.16-20221221` | This image must have both BCFtools and the score plugins available. |
...
| `doker_image_stablelift` | `stablelift_version` | `ghcr.io/uclahs-cds/stablelift:1.0.0`                        | This image is built and maintained via this repository.             |
